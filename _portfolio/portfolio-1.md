...
<img src='/images/UAV_WiNet.jpg' width='500' height='300'>"
collection: portfolio
---

To tackle the problem of energy-efficient wireless backhauling in UAV-assisted wireless networks, we propose a combinatorial optimization learning approach (COLA) that integrates a combinatorial algorithm into a neural network to quickly and effectively approximate the solution to the optimization problem. First, the neural network predicts the “magic” link weights given the application-level inputs. The link weights are then used by a simple Dijkstra's algorithm to find the shortest paths for the multi-commodity flows.
<img src='/images/UAV_WiNet.jpg' width='500' height='300'>
